// owner/booking/BookingReview.jsx
import React from "react";

const BookingReview = ({ formData, pets, sitters }) => {
  // Find the selected sitter
  const selectedSitter = sitters?.find(s => s.id === parseInt(formData.sitterId));
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#f0e6e4] rounded-xl p-6 space-y-4">
        ...
        <div className="flex justify-between py-2 border-b border-primary/20">
          <span className="text-gray-700 font-medium">Sitter:</span>
          <span className="font-semibold text-primary">
            {formData.sitterName || selectedSitter?.display_name || "Not selected"}
          </span>
        </div>
