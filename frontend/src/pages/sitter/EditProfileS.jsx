...
import { getSitterImage } from "../sitter/dashboard/utils";
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex gap-3 flex-wrap">
                      <label htmlFor="profile_picture" className="bg-primary text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-primary/90 cursor-pointer">
                        Upload New
                  ...
                  <div className="mb-6">
                    ...
                    <label htmlFor="banner_picture" className="bg-primary text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-primary/90 cursor-pointer">
                      Upload Banner
                      <input id="banner_picture" type="file" accept="image/*" onChange={handleBannerPictureChange} className="hidden" />
                    </label>
                    {bannerPicture && (
