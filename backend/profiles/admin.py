...
class TagAdmin(admin.ModelAdmin):
    # Admin for tags used by sitters
    ...
    def sitter_count(self, obj):
        # Show number of sitters using this tag with a link to filtered list
...
class PetInline(admin.TabularInline):
    # Inline display of pets under an owner profile
    model = Pet
    extra = 0
...
class OwnerProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Association", {"fields": ("user",)}),
        ("Profile Information", {"fields": ("name", "phone", "default_location", "notes")}),
        ("Images", {"fields": ("profile_picture", "profile_picture_preview", "banner_picture", "banner_picture_preview")}),
    )
    ...
    def pet_count(self, obj):
        ...
        return format_html('<strong>{}</strong> pets', count) if count > 0 else "0 pets"
...
class PetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Owner", {"fields": ("owner",)}),
        ("Pet Information", {"fields": ("name", "species", "breed", "age", "notes")}),
        ("Image", {"fields": ("profile_picture", "profile_picture_preview")}),
    )
...
class SitterProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Association", {"fields": ("user",)}),
        ("Profile Information", {"fields": ("display_name", "bio")}),
        ("Service Details", {"fields": ("rate_hourly", "service_radius_km", "home_zip")}),
        ("Rating & Verification", {"fields": ("avg_rating", "verification_status")}),
        ("Tags & Specialties", {"fields": ("tags", "specialties")}),
        ("Images", {"fields": ("profile_picture", "profile_picture_preview", "banner_picture", "banner_picture_preview")}),
    )
    ...
    def mark_verified(self, request, queryset):
        # Mark selected sitters as VERIFIED
    ...
    def mark_pending(self, request, queryset):
        # Mark selected sitters as PENDING
